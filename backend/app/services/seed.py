...
def seed_if_empty(db: Session) -> None:
    ...
    db.add(b)
    db.flush()
    blocked = BlockedFloor(building_id=b.id, floor=13)
    cars = [
    ...
    # A call aimed straight at the blocked floor: registration/dispatch refuses it.
    c4 = CallTicket(building_id=b.id, floor=13, direction="down", passengers=1, status="rejected")
